...
module.exports = (sequelize, DataTypes) => {
  const view_dispatch_advance_book = sequelize.define(
    "view_dispatch_advance_book",
    {
    ...
    },
    {
      ...
      underscored: false,
      tableName: "view_dispatch_advance_book"
    }
  );


    view_dispatch_advance_book.selectable = [
        "created_at",
        "order_id",
        "tracking_no",
        "dispatch_job_id",
  ...
  return view_dispatch_advance_book;
};

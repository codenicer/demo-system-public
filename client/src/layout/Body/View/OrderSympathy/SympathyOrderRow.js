...
import OrderRowAction from '../PendingOrders/PendingOrderRow/OrderRowAction/OrderRowAction';
...
const SympathyOrderRow = (props) => {

  const { currency } = config;
  const { css, bulk, selectedData, rowData, loadSelectedCustomer, idToArray, hub} = props;
  ...
  return (
    ...
    >
      {!bulk ?
        <OrderRowAction rowData={rowData} />
        :
...
export default React.memo(connect(null,{loadSelOrder,loadSelectedCustomer})(SympathyOrderRow))